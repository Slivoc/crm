...
CREATE TABLE stock_building_requisition_statuses (
    id SERIAL PRIMARY KEY,
    name TEXT NOT NULL UNIQUE,
    display_order INTEGER NOT NULL DEFAULT 0
);

CREATE TABLE stock_building_requisition_lists (
    id SERIAL PRIMARY KEY,
    name TEXT NOT NULL,
    instructions TEXT,
    status_id INTEGER NOT NULL,
...
CREATE TABLE stock_building_requisition_list_parts (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE stock_building_requisition_supplier_lines (
    id SERIAL PRIMARY KEY,
...
CREATE TABLE stock_building_requisition_supplier_breaks (
    id SERIAL PRIMARY KEY,
